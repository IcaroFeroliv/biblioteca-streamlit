...
with c2:
    servicos = ["Projeto Edificação", "Projeto Vias Urbanas", "Projeto Rodovias", "Plano Saneamento Básico - PMSB", "Projeto Saneamento", "Projeto Praças e Parques", "Estudos e Projetos Ambientais – Edificação", "Estudos e Projetos Ambientais - Infraestrutura",    "Plano Diretor", "Supervisão Gerenciamento Edificação", "Supervisão Gerenciamento Rodovias", "Supervisão Gerenciamento Vias Urbanas", "Supervisão Gerenciamento Saneamento", "Diversos", "Sondagem / Controle Tecnológico", "REURB Regularização Fundiária", "Topografia"]
...
if "Projeto Edificação" in servico or "Projeto Praças e Parques" in servico:
    ...
    if "CONTENÇÃO" in tipo_servico:
        ...
        with d4:
            m2 = st.number_input("M²", min_value=0.0, step=1.0, key="m2")
        with d5:
...
if st.button("Enviar"):
    if nome_atestado:
        ...
        dados_atestado = {
            ...
            "VU-ELETRICO(m²)": area_ele,
            "VU-KVA": kva_vu,
            "VU-EXTENSAO DE REDE(km)": area_extr,
            "VU-ILUMINACAO PUBLICA(pontos)": area_ilupu,
            ...
            "PR-TIPO ESTRUTURAL": tipo_estpep,
            "PR-ESTRUTURAL(m²)": area_est,
            "PR-PAVIMENTAÇÃO(km)": km_pavpr,
            "PR-PAVIMENTAÇÃO(m²)": m_pavpr,
            "PR-TIPO PAVIMENTAÇÃO": tipo_pavpr,
            "PR-SUB BASE": tipo_subasepr,
            "PR-SINALIZAÇÃO(km)": km_sinalpr,
            "PR-TIPO TOPOGRAFIA": tipo_toppr,
            "PR-CADASTRAL TOP": cadastral_toppr,
            "PR-TOPOGRAFIA(km)": km_toppr,
            "PR-TOPOGRAFIA(m²)": area_toppr,
            "PR-ORÇAMENTO(km)": km_orcpr,
            "PR-ORÇAMENTO(m²)": area_infraorcpr,
            "PR-TIPO CONTENÇÃO": tipo_contpr,
            "PR-CONTENÇÃO(m)": m_contpr,
            "PR-CONTENÇÃO(m²)": m2_contpr,
            "PR-CONTENÇÃO(m³)": m3_contpr,
            "PR-TIPO OAE": tipo_oaevupr,
            "PR-OAE(m²)": area_oaepr,
            "PR-OAE(vao)": vao_oaepr,
            "PR-TIPO FUNDAÇÃO": tipo_funduvpr,
            "PR-FUNDAÇÃO(m²)": m2_fundpr,
            "PR-TIPO MEIO AMBIENTE": tipo_meivupr,
            "PR-UNIDADE MEIO AMBIENTE": uni_meipr,
            "PR-COMPAT. PROJETOS(m²)": area_infracomppr,
            "PR-ELETRICO(m²)": area_ele,
            "PR-KVA": kva,
            "PR-EXTENSÃO DE REDE": area_extr,
            "PR-ILUMINAÇÃO PUBLICA": area_ilupu,
